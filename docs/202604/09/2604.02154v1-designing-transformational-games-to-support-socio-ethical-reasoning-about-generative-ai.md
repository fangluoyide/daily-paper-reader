...
tldr: 本研究探讨了如何通过变革性游戏提升青少年的批判性AI素养。研究设计并实施了《Diversity Duel》和《Secret Agent》两款游戏，将生成式AI工具与同伴评估、约束性创意和社交推理等机制结合。结果显示，这些游戏能有效引导参与者识别并讨论AI偏见，理解提示词设计对AI行为的影响，为培养社会伦理推理能力提供了新途径。
source: arxiv
...
motivation: 针对青少年在理解生成式AI的伦理复杂性及其局限性方面存在的挑战，探索更具参与感的学习方式。
method: 设计并实施了两款集成生成式AI工具的变革性游戏，重点考察同伴评估、约束性创意和社交推理三种机制对学习的支持作用。
result: 参与者能够识别并辩论AI输出中的偏见，将其与现实世界的不平等联系起来，并深入理解了提示词设计如何塑造AI行为。
conclusion: 结合特定游戏机制的小组合作游戏是培养青少年批判性AI素养和社会伦理推理能力的有效手段。
---

## 摘要
越来越多的年轻人需要具备批判性人工智能素养，不仅要了解人工智能的工作原理，还要理解其局限性和伦理细微差别。然而，设计能够让这些复杂且严肃的话题具有吸引力的学习体验仍然是一个挑战。本文探讨了将变革性游戏作为支持青少年学习生成式人工智能（GenAI）及其伦理的一种极具前景的方法。我们设计并实现了两款游戏——《多样性对决》（Diversity Duel）和《秘密特工》（Secret Agent），将 GenAI 工具与游戏元素相结合。本研究调查了游戏的三个元素：（1）同伴评价、（2）基于约束的创造力以及（3）社交推断，如何支持关于 GenAI 的社会伦理推理。参与者识别并辩论了 GenAI 输出中的偏见，将这些模式与现实世界的不平等联系起来，并对偏见产生了细致入微的理解。参与者进一步认识到提示词设计（prompt design）是如何塑造人工智能行为的。我们的研究结果表明，包含这些元素的基于小组的游戏可以支持培养批判性人工智能素养。
