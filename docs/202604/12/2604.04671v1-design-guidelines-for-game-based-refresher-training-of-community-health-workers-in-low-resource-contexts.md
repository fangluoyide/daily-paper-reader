...
title_zh: 低资源环境下社区卫生工作者游戏化复训的设计指南
authors: "Arka Majhi, Aparajita Mondal, Satish B. Agnihotri"
date: 2026-04-06
pdf: "https://arxiv.org/pdf/2604.04671v1"
tags: ["query:cog-eld"]
score: 7.0
evidence: 基于游戏的复训与互动健康干预
tldr: 本研究针对资源匮乏地区社区卫生工作者（CHW）培训难持续的问题，基于在印度开展的为期四年的设计研究，探索了包括移动应用、增强现实及卡片游戏在内的多种游戏化培训系统。通过混合方法分析，总结出涵盖情境真实性、社交激励及职业认同等维度的八项设计指南，为低资源环境下开发交互式医疗干预措施提供了实践指导。
source: arxiv
selection_source: fresh_fetch
motivation: 旨在解决资源匮乏地区社区卫生工作者在持续培训和绩效维持方面面临的挑战。
method: 基于为期四年的设计研究，通过访谈、实地观察和日志分析，对多种游戏化培训系统进行混合方法评估。
result: 提炼出涉及情境真实性、自适应学习、混合交互、社交激励、解释性及职业认同等维度的八项关键设计指南。
conclusion: 为在低资源医疗环境下开发能够促进持续参与、知识迁移且符合情境的交互式干预工具提供了可操作的设计知识。
---

## 摘要
社区卫生工作者（CHW）在低资源地区提供初级医疗卫生服务方面发挥着至关重要作用，然而，维持其培训效果和工作表现仍是一项持久挑战。先前的研究已经探索了针对 CHW 培训的数字化和基于游戏的方法。然而，目前很少有研究将长期的设计见解总结为可推广的交互式健康干预指南。基于一项为期四年的基于设计的研究项目，该项目涉及多种基于游戏的复训系统（包括基于问答的移动应用、实体和增强现实游戏、卡牌游戏以及基于位置的游戏），我们探讨了哪些设计指南能够支持 CHW 培训中的持续参与、学习迁移和情境适宜性。我们对印度公认社会健康活动家（ASHA）和安甘瓦迪工作者（AWW）的部署情况进行了混合方法分析，包括访谈、实地观察和使用日志。通过主题合成，我们得出了八项设计指南，涵盖了情境真实性、自适应学习、混合交互、社交动机、可解释性、职业认同和伦理考量。我们的研究结果为在低资源医疗环境下开发交互式健康干预措施的研究人员和从业者提供了可操作的设计知识。
